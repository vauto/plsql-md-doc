...
const { TagSyntaxNode, SeeTagSyntaxNode } = require("./javadoc/syntax")
...
class Tag {
  ...
  /**  @type {string?} */
  get id() {
    console.assert(false, 'whoops tag')
...
class SeeTag extends Tag {
  ...
  constructor(syntax) {
    mustBeInstanceOf(syntax, SeeTagSyntaxNode, 'syntax')
    super(syntax)
