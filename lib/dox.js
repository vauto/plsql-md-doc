...
class DocumentGenerator {
  ...
  *readComments(syntax, parentContext) {
    ...
    mustBeInstanceOfAny(syntax, 'syntax', DeclarationStatementSyntaxNode, DeclarationExpressionSyntaxNode)
    ...
    switch (true) {
      ...
      case syntax instanceof CreatePlsqlUnitStatementSyntaxNode:
        ...
        break
      case syntax instanceof FunctionDeclarationStatementSyntaxNode:
      case syntax instanceof ProcedureDeclarationStatementSyntaxNode:
  ...
  *parseDocCommentSyntax(syntax) {
   ...
   * @returns {CodeContext}
   */
  mapAnnotationToCodeContext = (annotation, parent) => {
    return new CodeContext({
      parent,
      kind: 'annotation',
      name: this.#mapIdentifier(annotation.name),
      // target: annotation.target.name,
      message: parent.resolveContent(annotation.message),
