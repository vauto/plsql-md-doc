...
const identifierRules = [
  ...
  // PL/SQL bare identifiers/keywords.
  {
...
class JavadocTokenizer extends Tokenizer {
  static #lexerData = {
    default: {
      ...
      // "whitespace" means non-newline whitespace, plus stars
    ...
    'inlineTag': {
      ...
      'url': [
        absoluteUrlRule,
        // Also include file paths, excluding braces.  You have to encode 'em, sorry.
        {
          // Ends with file extension? file.
