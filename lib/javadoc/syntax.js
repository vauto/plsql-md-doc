...
class JavadocNodeReader extends SyntaxNodeReader {
  ...
  #tryReadNextAsIdentifier() {
    return this.tryReadNextAs(Patterns.IDENTIFIER, this.#readAsIdentifier)
  }
  ...
  *#readNextAsNamePathParametersWithCommas() {
  ...
  #tryReadNextAsNamePathParameterList() {
    return this.tryReadNextAs(Patterns.OPEN_PAREN, this.#readAsNamePathParameterList)
  }
  ...
  *#readNextAllAsBraceContents() {
  ...
  #tryReadNextAsBraceExpression() {
    return this.tryReadNextAs(Patterns.OPEN_BRACE, this.#readAsBraceExpression)
  }
  ...
  *#readNextAsBracketContents() {
  ...
  #tryReadNextAsBracketExpression() {
    return this.tryReadNextAs(Patterns.OPEN_BRACKET, this.#readAsBracketExpression)
  }
  ...
  #tryReadNextAsInlineContentLike() {
    return this.tryReadNextAs(Patterns.INLINE_CONTENT_LIKE, this.#readAsInlineContentLike)
  }
  ...
  *#readNextAllAsInlineContentLike() {
  ...
  #tryReadNextAsBlockContentLike() {
    return this.tryReadNextAs(Patterns.BLOCK_CONTENT_LIKE, this.#readAsBlockContentLike)
  }
  ...
  *#readNextAllAsBlockContentLike() {
   ...
   */
  #tryReadNextAsUrl() {
    return this.tryReadNextAs(Patterns.URL, this.#readAsUrl)
  }
  ...
  #tryReadNextAsLiteralExpression() {
    return this.tryReadNextAs([Patterns.NUMBER_LITERAL, Patterns.STRING_LITERAL], this.#readAsLiteralExpression)
  }
   ...
   */
  #tryReadNextAsTag() {
    return this.tryReadNextAs(Patterns.TAG, this.#readAsTag)
  }
