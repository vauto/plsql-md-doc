...
class SeeTagSyntaxNode extends TagSyntaxNode {
  /** @type {AnyExpressionSyntaxNode?} */ href
  /** @type {ContentSyntaxNode[]} */ content

  /**
   * @param {TokenLike} kind
   * @param {AnyExpressionSyntaxNode?} href
   * @param {...ContentSyntaxNode} content
   */
  constructor(kind, href, ...content) {
    super(kind, href, ...content)
    mustBeInstanceOf(href, SyntaxNode, 'href')
    this.href = href
