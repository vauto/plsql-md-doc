...
const { SyntaxNode, SyntaxNodeOrTokenLike, SyntaxNodeOrToken, TokenLike, IdentifierSyntaxNode, StatementSyntaxNode, SyntaxNodeReader, ExpressionSyntaxNode } = require('../syntax')
...
class ParamTagSyntaxNode extends TagSyntaxNode {
  ...
  constructor(kind, { type, name, defaultExpression, defaultValue, content }) {
    ...
    if (defaultExpression) {
      this.push(defaultExpression, defaultValue)
