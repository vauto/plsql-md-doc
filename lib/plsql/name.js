...
const { MethodDeclarationStatementSyntaxNodeBase, MethodDeclarationExpressionSyntaxNode } = require('./syntax')
...
class PlsqlUniqueId {
  ...
  static from(value) {
    switch (true) {
      ...
      case value instanceof MethodDeclarationExpressionSyntaxNode:
