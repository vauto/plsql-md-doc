...
const { IdentifierSyntaxNode, ExpressionSyntaxNode, SyntaxNode, } = require('../syntax')
const { MethodDeclarationStatementSyntaxNodeBase, TypeExpressionSyntaxNode, IdentifierTypeExpressionSyntaxNode } = require('./syntax')
...
class PlsqlUniqueId {
  ...
  /**
   *
   * @param {(PlsqlUniqueId | MethodDeclarationStatementSyntaxNodeBase | NamePathExpressionSyntaxNode)?} value
  ...
  static from(value) {
    switch (true) {
      ...
      case value instanceof PlsqlUniqueId:
        return value
      case value instanceof MethodDeclarationStatementSyntaxNodeBase:
