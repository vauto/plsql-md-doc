...
class PlsqlNodeReader extends SyntaxNodeReader {
  ...
  *#tryReadNextAsParametersWithCommas() {
   ...
   * @returns {PragmaStatementSyntaxNode}
  ...
  #readAsPragma(keyword) {
    ...
    return new PragmaStatementSyntaxNode({ keyword, name, parameters, terminator: this.#readNextAsTerminator() })
  }
...
class PragmaStatementSyntaxNodeBase extends DeclarationStatementSyntaxNode {
  /** @override */
  memberKind = 'Pragma'
}

class PragmaStatementSyntaxNode extends PragmaStatementSyntaxNodeBase {
