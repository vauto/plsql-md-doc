...
class PlsqlNodeReader extends SyntaxNodeReader {
  ...
  *#tryReadUpToNextDocComment() {
  ...
  #tryReadNextAsParameterDeclaration() {
    ...
    // LATER: expression vs statement is f.
    return new StatementSyntaxNode({ name, in: inQualifier, out: outQualifier, nocopy: nocopyQualifier, type, defaultExpr, defaultValue })
  }
  ...
  *#tryReadNextAsParameterDeclarations() {
  ...
  #tryReadNextAsParameterListDeclaration() {
    ...
    return new SyntaxNode(
      lparen,
      ...this.#tryReadNextAsParameterDeclarations(),
      this.readNextToken(')')
    )
  }
