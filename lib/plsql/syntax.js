...
class PlsqlNodeReader extends SyntaxNodeReader {
  ...
  *#readNextAsTypeModifiers() {
  ...
  #tryReadNextAsNumberLiteral() {
    ...
    return token ? this.#readAsNumberLiteral(token) : null
  }
  ...
  #readNextAsNumberLiteral() {
    return this.#readAsNumberLiteral(this.readNextToken(Patterns.NUMBER_LITERAL))
  }
  ...
  #readAsNumberExpression(token) {
    ...
    return this.#readAsNumberLiteral(token)
  }
  ...
  #tryReadNextAsSingleValueExpression() {
    ...
    const unaryOperator = SyntaxNode.asSyntaxNode(this.tryReadNextToken(['+', '-']))
    if (unaryOperator) {
