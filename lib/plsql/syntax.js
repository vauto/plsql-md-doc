  ...
  *#tryReadNextAsInheritanceClauses() {
  ...
  #tryReadNextAsObjectConstructorMethod(inheritance) {
    ...
    return new MethodDeclarationStatementSyntaxNode({
      keyword: new SyntaxNode(...inheritance, ...constructor),
      name: this.readNextAsIdentifier(),
      parameters: this.#tryReadNextAsParameterListDeclaration(),
      return: this.tryReadNextTokens('RETURN', 'SELF', 'AS', 'RESULT'),
    })
  }
  ...
  #readNextAsTypeSpec(create, editionable, objectType) {
    ...
    if (typeType) {
      return new CreateBaseObjectTypeStatementSyntaxNode({
        ...
        authid, accessibleBy,
        is,
        attributes: this.#tryReadNextAsObjectMemberListDeclaration(),
...
class CreateBaseObjectTypeStatementSyntaxNode extends CreatePlsqlUnitStatementSyntaxNode {
  /** @property {SyntaxNode} */ is
  /** @property {ObjectMemberListDeclarationExpressionSyntaxNode} */ attributes
   ...
   * @param {ObjectMemberListDeclarationExpressionSyntaxNode} attributes
...
class MethodDeclarationStatementSyntaxNode extends StatementSyntaxNode {
  ...
  /**
   * @param {SyntaxNode} token  The initial token (`FUNCTION`)
   * @param {IdentifierSyntaxNode} name
   * @param {ParameterListDeclarationExpressionSyntaxNode?} parameters
   * @param {ReturnDeclarationExpressionSyntaxNode?} return
   */
