...
class FunctionDeclarationStatementSyntaxNode extends MethodDeclarationStatementSyntaxNodeBase {
   ...
   * @param {SyntaxNode?} terminator
   */
  constructor(methodKeyword, name, parameterList, returnClause, unitModifiers, body, terminator) {
    super(methodKeyword, name, parameterList, returnClause, unitModifiers, body, terminator)
...
class ProcedureDeclarationStatementSyntaxNode extends MethodDeclarationStatementSyntaxNodeBase {
   ...
   * @param {SyntaxNode?} terminator
   */
  constructor(methodKeyword, name, parameterList, unitModifiers, body, terminator) {
    super(methodKeyword, name, parameterList, unitModifiers, body, terminator)
    // Must resolve the canonical tokens.
    this.methodKeyword = this.resolveToken(methodKeyword)
    this.name = name
    this.parameterList = parameterList
