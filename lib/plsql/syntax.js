...
class CreateStandaloneMethodStatementSyntaxNode extends CreatePlsqlUnitStatementSyntaxNode {
  ...
  /**
   * @param {CreateMethodExpressionSyntaxNode} createExpression
   ...
   */
  constructor(createExpression, isOrAsKeyword, docComment, body, semicolonToken, slashToken) {
    mustBeInstanceOf(createExpression, CreateMethodExpressionSyntaxNode, 'createExpression')
...
class CreatePackageStatementSyntaxNode extends CreatePlsqlUnitStatementSyntaxNode {
  ...
  /**
   * @param {CreatePackageExpressionSyntaxNode} createExpression
   * @param {TokenLike} isOrAsKeyword The `IS` or `AS` keyword.
   * @param {DocumentCommentSyntaxNode?} docComment
   ...
   * @param {TokenLike?} slashToken The terminating slash (`/`), if any.
   */
  constructor(createExpression, isOrAsKeyword, docComment, content, semicolonToken, slashToken) {
