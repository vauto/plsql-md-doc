...
class PlsqlNodeReader extends SyntaxNodeReader {
  ...
  *#readNextAsTypeModifiers() {
  ...
  #readAsTypeExpression(token) {
    ...
    return notNull ? new TypeExpressionSyntaxNode(type, [notNull]) : type
  }
...
class NamedTypeExpressionSyntaxNode extends TypeExpressionSyntaxNode {
...
exports.NamedTypeExpressionSyntaxNode = NamedTypeExpressionSyntaxNode
 ...
 */
class CharacterTypeExpressionSyntaxNode extends NamedTypeExpressionSyntaxNode {
 ...
 * @example `NUMBER(5, 2)`
 */
class NumericTypeExpressionSyntaxNode extends NamedTypeExpressionSyntaxNode {
