...
const { TokenSyntaxError } = require('../token')
  ...
  *#tryReadNextAsParametersWithCommas() {
  ...
  #tryReadNextAsTerminator() {
    ...
    if (terminatorPlusOther) {
      console.assert(false, `${terminatorPlusOther.start} Expected SEMICOLON but found ${terminatorPlusOther}`, terminatorPlusOther)
