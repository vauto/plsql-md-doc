...
class PlsqlNodeReader extends SyntaxNodeReader {
  ...
  *#readNextAsInvocationParametersWithCommas() {
  ...
  /**
   * Reads starting with the given token as a method declaration.
  ...
  #readRestOfStandaloneFunction(create, editionable, unitType, ifNotExists) {
    ...
    const declaration = new MethodDeclarationExpressionSyntaxNode(unitType)
    const header = new CreateMethodExpressionSyntaxNode(create, editionable, unitType, ifNotExists)
  ...
  *#readNextAsPackageSpecContent() {
  ...
  #readRestOfPackageSpec(create, editionable, unitType, ifNotExists) {
    ...
    const header = new CreatePackageExpressionSyntaxNode(create, editionable, unitType, ifNotExists, name, unitModifiers)
  ...
  *#readNextAsTypeModifiers() {
  ...
  #readRestOfTypeSpec(create, editionable, unitType, ifNotExists) {
    ...
    const header = new CreateTypeExpressionSyntaxNode(create, editionable, unitType, ifNotExists, name, force, oid, unitModifiers)
 ...
 */
class CreateUnitExpressionSyntaxNode extends ExpressionSyntaxNode {
  #unitType
  #name
  #unitModifiers
   ...
   */
  constructor(create, editionable, unitType, ifNotExists, ...nodesOrTokens) {
    super(create, editionable, unitType, ifNotExists, ...nodesOrTokens)
    this.#unitType = unitType

    // Default behavior is to search immediate children for name/unit modifiers.
  ...
  /** @type {IdentifierSyntaxNode} The name of the unit. */
  get name() { return this.#name }
...
class CreatePlsqlUnitStatementSyntaxNode extends SqlStatementSyntaxNode {
  /** @type {CreateUnitExpressionSyntaxNode} */ header
  /** @type {DocumentCommentSyntaxNode?} */ docComment

  /**
   * @param {CreateUnitExpressionSyntaxNode} header
   * @param {...SyntaxNodeOrTokenLikeOrIterable} nodesOrTokens
   */
...
class CreateMethodExpressionSyntaxNode extends CreateUnitExpressionSyntaxNode {
  /** @type {MethodDeclarationExpressionSyntaxNode} The method declaration expression */ declaration
   ...
   * @param {UnitTypeSyntaxNode} unitType
   * @param {SyntaxNode?} ifNotExists
   * @param {MethodDeclarationExpressionSyntaxNode} declaration
   */
  constructor(create, editionable, unitType, ifNotExists, declaration) {
    super(create, editionable, unitType, ifNotExists, declaration)
    this.declaration = declaration
  }

  get name() { return this.declaration.name }
  get unitModifiers() { return this.declaration.unitModifiers }
}
exports.CreateFunctionExpressionSyntaxNode = CreateMethodExpressionSyntaxNode
...
class CreatePackageStatementSyntaxNode extends CreatePlsqlUnitStatementSyntaxNode {
  ...
  /**
   * @param {CreatePackageExpressionSyntaxNode} header
  ...
  constructor(header, isOrAsKeyword, docComment, content, semicolonToken, slashToken) {
    mustBeInstanceOf(header, CreatePackageExpressionSyntaxNode, 'header')
...
class CreateObjectTypeStatementSyntaxNode extends CreateTypeStatementSyntaxNode {
  ...
  /**
   * @param {CreateTypeExpressionSyntaxNode} header
  ...
  constructor(header, isOrUnderKeyword, keywordOrBaseType, memberList, typeModifiers, semicolonToken, slashToken) {
    mustBeInstanceOf(header, CreateTypeExpressionSyntaxNode, 'header')
...
class MethodDeclarationExpressionSyntaxNodeBase extends DeclarationExpressionSyntaxNode {
  ...
  get methodKind() {
    return this.methodType.name.toLowerCase()
  }
...
class UnitTypeSyntaxNode extends SyntaxNode {
  ...
  constructor(tokens, name = undefined) {
    ...
    console.assert(/^\w+(?: \w+)?$/.test(this.name), 'invalid name', this.name)
  }
}
