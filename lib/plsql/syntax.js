...
class PlsqlNodeReader extends SyntaxNodeReader {
  ...
  *#readNextAsAccessorsWithCommas() {
   ...
   * @returns {ParameterExpressionSyntaxNode?}
   */
  ...
  *#readNextAsInvocationParametersWithCommas() {
  ...
  #readAsPragmaDeclaration(keyword) {
    ...
    const lparen = this.#tryReadNextAsLeftParen()
    const parameters = lparen ? new ParameterListExpressionSyntaxNode(lparen, [...this.#readNextAsInvocationParametersWithCommas()], this.#readNextAsRightParen()) : null
  ...
  *#readNextAsReturnModifiers() {
   ...
   * @returns {ParameterDeclarationExpressionSyntaxNode?}
   */
