...
class CreatePackageStatementSyntaxNode extends CreatePlsqlUnitStatementSyntaxNode {
   ...
   */
  constructor({ create, editionable, unitType, name, unitModifiers, is, docComment, content }) {
    super(create, editionable, unitType, name, unitModifiers, is, docComment, ...content)
...
class CreateTypeStatementSyntaxNode extends CreatePlsqlUnitStatementSyntaxNode {
  /** @property {SyntaxNode[]} */ typeModifiers
}
...
class CreateBaseObjectTypeStatementSyntaxNode extends CreateTypeStatementSyntaxNode {
   ...
   */
  constructor({ create, editionable, unitType, name, force, oid, unitModifiers, is, keyword, members, typeModifiers, terminator }) {
    super(create, editionable, unitType, name, force, oid, unitModifiers, is, keyword, members, typeModifiers, terminator)
    this.unitType = unitType
    this.name = name
...
class CreateInheritedObjectTypeStatementSyntaxNode extends CreateTypeStatementSyntaxNode {
   ...
   * @param {SyntaxNode} params.terminator
   */
  constructor({ create, editionable, unitType, name, force, oid, unitModifiers, under, baseType, members, typeModifiers, terminator }) {
    super(create, editionable, unitType, name, force, oid, unitModifiers, under, baseType, members, typeModifiers, terminator)
    this.unitType = unitType
    this.name = name
...
class CreateNestedTableTypeStatementSyntaxNode extends CreateTypeStatementSyntaxNode {
   ...
   * @param {SyntaxNode} params.terminator
   */
  constructor({ create, editionable, unitType, name, force, oid, unitModifiers, is, docComment, specification, typeModifiers, terminator }) {
    super(create, editionable, unitType, name, force, oid, unitModifiers, is, docComment, specification, typeModifiers, terminator)
    this.unitType = unitType
    this.name = name
    this.docComment = docComment
    this.typeModifiers = typeModifiers
