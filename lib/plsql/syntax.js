  ...
  *#readNextAsInvocationParametersWithCommas() {
  ...
  #readAsFunctionDeclaration(token) {
    ...
    return new FunctionDeclarationStatementSyntaxNode({
      ...
      modifiers: [...this.#readNextAsMethodDeclarationModifiers()],
  ...
  *#readNextAsTypeModifiers() {
  ...
  #tryReadNextAsSingleValueExpression() {
    ...
    if (unaryOperator) {
      ...
      console.assert(!number, `${unaryOperator.start} number should have eaten this`)
   ...
   * @returns {SyntaxNode?}
   */
  #tryReadNextAsMethodDeclarationModifier() {
  ...
  /**
   * Reads a sequence of zero or more method declaration modifiers.
   * @returns {Generator<SyntaxNode>}
   * @yields {SyntaxNode}
   */
  *#readNextAsMethodDeclarationModifiers() {
    let modifier
    while (modifier = this.#tryReadNextAsMethodDeclarationModifier()) {
      yield modifier
    }
  }
...
class CreateInheritedObjectTypeStatementSyntaxNode extends CreateTypeStatementSyntaxNode {
   ...
   * @param {SyntaxNode} params.terminator
   */
  constructor({ create, editionable, unitType, name, force, oid, authid, accessibleBy, under, baseType, members, modifiers, terminator }) {
    super(create, editionable, unitType, name, force, oid, authid, accessibleBy, under, baseType, members, modifiers, terminator)
    this.unitType = unitType
    this.name = name
...
class FunctionDeclarationStatementSyntaxNode extends MethodDeclarationStatementSyntaxNodeBase {
   ...
   * @param {SyntaxNode?} params.terminator
   */
  constructor({ keyword, name, parameters, returnClause, modifiers, body, terminator }) {
    super(keyword, name, parameters, returnClause, modifiers, body, terminator)
    this.keyword = keyword
    this.name = name
...
class ProcedureDeclarationStatementSyntaxNode extends FunctionDeclarationStatementSyntaxNode {
   ...
   * @param {SyntaxNode?} params.terminator
   */
  constructor({ keyword, name, parameters, modifiers, body, terminator }) {
    super({ keyword, name, parameters, modifiers, body, terminator })
  }
}
...
class ObjectMethodDeclarationStatementSyntaxNode extends ObjectMethodDeclarationStatementSyntaxNodeBase {
   ...
   * @param {...SyntaxNodeOrToken} params
   */
  constructor({ inheritance, mapOrOrder, memberOrStatic, keyword, name, parameters, returnClause, modifiers }) {
    super(inheritance, mapOrOrder, memberOrStatic, keyword, name, parameters, returnClause, modifiers)
...
class ConstructorDeclarationStatementSyntaxNode extends ObjectMethodDeclarationStatementSyntaxNodeBase {
  constructor({ inheritance, constructor, functionKeyword, name, parameters, returnClause, modifiers }) {
    super(inheritance, constructor, functionKeyword, name, parameters, returnClause, modifiers)
