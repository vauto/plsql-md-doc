 ...
 *
 * This is for convenience to get at the fields, etc.
 */
class RecordTypeDeclarationStatementSyntaxNode extends TypeDeclarationStatementSyntaxNode {
  /** @override @type {RecordTypeExpressionSyntaxNode} */
  baseType = null
...
class DeprecatePragmaDeclarationStatementSyntaxNode extends PragmaDeclarationStatementSyntaxNode {
  ...
  createAnnotation(target) {
    ...
    return new Annotation('deprecated', target, this.message?.toString())
  }
}
...
/**
 * Represents the list of fields in a record type declaration, with attendant punctuation.
 */
