...
class PlsqlNodeReader extends SyntaxNodeReader {
  ...
  *#readToEndOfLine() {
  ...
  /**
   * Reads the token plus subsequent ones as an identifier.
  ...
  /**
   * Tries reading an identifier node next.
   * @param {TokenLike} token
   * @returns {IdentifierSyntaxNode?}
   */
  ...
  /** @returns {SyntaxNode} */
  #readNextAsLeftParen() { return SyntaxNode.asSyntaxNode(this.readNextToken(Patterns.LPAREN)) }
  /** @returns {SyntaxNode} */
  #readNextAsRightParen() { return SyntaxNode.asSyntaxNode(this.readNextToken(Patterns.RPAREN)) }
