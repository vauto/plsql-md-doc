  ...
  *#tryReadNextAsParameterDeclarationsWithCommas() {
  ...
  #readAsVariableDeclaration(token) {
    ...
    if (exception) {
      ...
      return new ExceptionDeclarationStatementSyntaxNode({ name, keyword: exception })
    }
...
class SubtypeDeclarationStatementSyntaxNode extends DeclarationStatementSyntaxNode {
