...
class CreateNestedTableTypeStatementSyntaxNode extends CreateTypeStatementSyntaxNode {
   ...
   * @param {SyntaxNode} params.terminator
   */
  constructor({ create, editionable, unitType, name, force, oid, unitModifiers, is, docComment, baseType, typeModifiers, terminator }) {
    super(create, editionable, unitType, name, force, oid, unitModifiers, is, docComment, baseType, typeModifiers, terminator)
    this.unitType = unitType
    this.name = name
    this.docComment = docComment
    this.typeModifiers = typeModifiers
