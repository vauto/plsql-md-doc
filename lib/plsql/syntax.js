...
class DeclarationStatementSyntaxNode extends StatementSyntaxNode {
  ...
  /** @type {string} The friendly name of the kind of member (e.g., `Procedure`). */
  get memberKind() {
    return this.kind.replace(/DeclarationStatement$/, '')
  }
...
class DeclarationExpressionSyntaxNode extends ExpressionSyntaxNode {
  ...
  /** @type {string} The friendly name of the kind of member (e.g., `Procedure`). */
  get memberKind() {
    return this.kind.replace(/DeclarationExpression$/, '').toUpperCase()
  }
}
...
class MethodDeclarationExpressionSyntaxNodeBase extends DeclarationExpressionSyntaxNode {
  ...
  /** @type {ReturnDeclarationExpressionSyntaxNode?} The return clause for this declaration, if any. */ returnClause
  ...
  constructor(...nodesOrTokens) {
    ...
    this.parameterList = this.children.find(ofType(DeclarationParameterListExpressionSyntaxNode)) ?? null
    this.returnClause = this.children.find(ofType(ReturnDeclarationExpressionSyntaxNode)) ?? null
  }

  get memberKind() {
    return this.methodKeyword.value
  }
 ...
 */
class MethodDeclarationStatementSyntaxNodeBase extends StatementSyntaxNode {
...
exports.ConstructorDeclarationStatementSyntaxNode = ConstructorDeclarationExpressionSyntaxNode
