...
class PlsqlNodeReader extends SyntaxNodeReader {
  ...
  *#readThroughEndOfLine() {
  ...
  #tryReadNextAsIdentifier() {
    return this.tryReadNextAs(Patterns.ANY_IDENTIFIER, this.#readAsIdentifier)
  }
  ...
  #readNextAsIdentifier() {
    return this.readNextAs(Patterns.ANY_IDENTIFIER, this.#readAsIdentifier)
  }
  ...
  *#readNextAsInvocationParametersWithCommas() {
  ...
  #readAsFunctionDeclaration(methodKeyword) {
    Token.mustMatch(Patterns.FUNCTION, methodKeyword)
  ...
  #readAsProcedureDeclaration(methodKeyword) {
    Token.mustMatch(Patterns.PROCEDURE, methodKeyword)
