  ...
  for (const comment of content.json) {
    ...
    comment.tags.forEach(function (tag) {
      switch (tag.kind) {
        ...
        case 'description':
          if (tag.content) {
            console.assert(!entity.description, `${tag.textSpan} oops two descriptions hohoho`, entity.description, tag.content)
        ...
        case 'param':
          {
            ...
            if (param) {
              ...
              console.warn(`${tag.syntax.start} @param not found`, tag);
            }
          }
          break;
        case 'throws':
