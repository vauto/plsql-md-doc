...
class SyntaxNodeReader {
   ...
   */
  tryReadNextAs(pattern, readerFunction) {
    const token = this.tryReadNextToken(pattern)
    return token ? readerFunction.call(this, token) : null
  }
   ...
   */
  readNextAs(pattern, readerFunction) {
