...
class TokenGroup {
  ...
  /** @type {string} The match contents. */ value
  ...
  constructor(tokens) {
    ...
    tokens.forEach((t, i) => mustBeToken(t, `tokens[${i}]`))
    this.tokens = tokens
 ...
 * @returns {TokenLike?}
 */
const asTokenLike = (value) => isTokenLike(value) ? value : undefined
exports.asTokenLike = asTokenLike
